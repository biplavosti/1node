...
set -v
ARGS="--nodiscover --permissioned --verbosity 5 --networkid $NETWORK_ID --raft --rpc --rpcapi eth,net,web3 --emitcheckpoints"
PRIVATE_CONFIG=qdata/c1/tm.ipc nohup geth --datadir qdata/dd1 $ARGS --nodekey qdata/dd1/geth/nodekey --unlock 0 --password qdata/dd1/password --raftport 50401 --rpcport 22000 --port 21000 2>>qdata/logs/1.log &
set +v
